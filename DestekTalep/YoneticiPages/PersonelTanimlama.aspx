<%@ Page Title="Personel Tanımlama" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PersonelTanimlama.aspx.cs" Inherits="DestekTalep.PersonelTanimlama" %>
...
/* color */
    ...
    <div style="background-color:lightskyblue; border-radius:15px;">
        <br />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label1" runat="server" Text="Personel Adı ve Soyadı :" Font-Bold="True" Font-Names="corbel" ForeColor="White"></asp:Label>
&nbsp;<asp:TextBox ID="txt_personelAdi" runat="server" Font-Names="corbel"></asp:TextBox>
    <br />
&nbsp;<br />
    <asp:Button ID="btn_ekle" runat="server" CssClass="auto-style1" OnClick="btn_ekle_Click" Text="EKLE" Font-Bold="True" Font-Names="corbel" Font-Size="10pt" />
    <br />
    </div>
        ...
        <AlternatingRowStyle CssClass="alt"></AlternatingRowStyle> 
           <Columns>
            <asp:TemplateField HeaderText="Güncelle">
                <ItemTemplate>
                <a href='PersonelTanimlama.aspx?PersonelID=<%#Eval("PersonelID")%>'>
