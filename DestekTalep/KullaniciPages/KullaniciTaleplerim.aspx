<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KullaniciTaleplerim.aspx.cs" Inherits="DestekTalep.Taleplerim1" %>
...
<head runat="server">
    ...
    <title><%: Page.Title %>- Taleplerim </title>
...
/* color */
	...
	box-shadow:		 	inset rgba(255,254,255,0.6) 0 0.3em .3em, inset rgba(0,0,0,0.15) 0 -0.1em .3em, /* inner shadow */ 
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label1" runat="server" Text="Talep İçeriği :"></asp:Label>
        &nbsp;
        <asp:TextBox ID="txt_talepIcerik" runat="server" TextMode="MultiLine"></asp:TextBox>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label2" runat="server" Text="Talep Türü :"></asp:Label>
        &nbsp;&nbsp;&nbsp;
        <asp:DropDownList ID="ddl_talepTuru" runat="server" CssClass="ddlstyle" Height="30px" Width="126px">
        ...
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_ekle" runat="server" CssClass="auto-style1" OnClick="Button1_Click" Text="Yeni Talep" />
        <br />
        <br />
        </div>
        ...
        <asp:GridView ID="GridView1" runat="server"  CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" Font-Size="8pt">
          <Columns>
              <asp:TemplateField HeaderText="Güncelle">
                  <ItemTemplate>
                      <a href='KullaniciTaleplerim.aspx?TalepID=<%#Eval("TalepID") %>'>
                           <asp:Button ID="button" Text="Güncelle" CssClass="button" runat="server" />
                      </a>
                  </ItemTemplate>
              </asp:TemplateField>
          </Columns>
